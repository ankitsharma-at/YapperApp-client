  ...
  useEffect(() => {
    const fetchPost = async () => {
      ...
      try {
        ...
        const communityResponse = await axios.get(`${process.env.REACT_APP_SERVER_URL}/api/community/${response.data.community}`);
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_SERVER_URL}/api/post/${postId}/comment`,
        { content: newComment },
